...
Boğaziçi İlgi Koleji olarak, öğrencilerimizin akademik başarılarının yanı sıra, milli ve manevi değerlerine bağlı, evrensel düşünebilen, sorgulayan ve üreten bireyler olmalarını önemsiyoruz.`
    ...
    "egitim-yaklasimimiz": {
      ...
      principles: [
        { title: "Bütünsel Gelişim", desc: "Akademik, sosyal ve duygusal gelişimi birlikte destekliyoruz." },
        { title: "Aktif Öğrenme", desc: "Yaparak ve yaşayarak öğrenme metodlarını uyguluyoruz." },
        { title: "Disiplinlerarası Çalışma", desc: "Farklı disiplinleri birleştiren projeler geliştiriyoruz." },
        { title: "Teknoloji Entegrasyonu", desc: "Modern teknolojileri eğitim sürecine dahil ediyoruz." }
      ]
    }
  },
  akademik: {
