    ...
    <>
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3" style={{ background: "linear-gradient(180deg, #f0f4ff 0%, #f8fafc 100%)" }}>
              ...
              {isLoading && (
                ...
                >
                  <div className="w-7 h-7 rounded-full bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center shrink-0 shadow-sm">
                    <Bot className="w-3.5 h-3.5 text-white" />
                  </div>
      ...
      <AnimatePresence>
        {showTooltip && !isOpen && (
          <motion.div
            ...
            className="fixed bottom-20 right-4 z-[9998] bg-white rounded-xl shadow-xl px-4 py-3 max-w-[220px] border border-gray-100"
          >
      ...
      <div className="fixed bottom-4 right-4 z-[9999]">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="relative w-[60px] h-[60px] rounded-full bg-gradient-to-br from-[#1a365d] via-[#1e40af] to-[#3b82f6] text-white flex items-center justify-center shadow-xl"
        ...
        >
          ...
          {!isOpen && !hasInteracted && (
            <span className="absolute -top-0.5 -right-0.5 w-4 h-4 bg-green-400 rounded-full border-[2.5px] border-white shadow-sm" />
          )}
        </motion.button>
      </div>
    </>
